...
{
    [UnityEditor.AssetImporters.ScriptedImporter(1, new[] { "gltf", "glb", "ply", "stl", "3mf" })]
    public class TriLibScriptedImporter : UnityEditor.AssetImporters.ScriptedImporter
    {
        ...
        public override void OnImportAsset(UnityEditor.AssetImporters.AssetImportContext assetImportContext)
        {
        ...
        private static void OnError(IContextualizedError contextualizedError)
        {
            ...
            {
                var assetImportContext = (UnityEditor.AssetImporters.AssetImportContext)assetLoaderContext.Context.CustomData;
